...
<div class="text-center">
    <h4 class="bg-info p-2 text-white bg-opacity-75">Paciente actualmente {{$paciente->estado}}: {{$paciente->primerNombre}} {{$paciente->apellidoPaterno}} {{$paciente->apellidoMaterno}}</h4>
</div>
