<div>
    ...
    <div class="row">
        ...
        <div class="col p-2 mt-0.5">
            ...
            <input type="text" name="historia" class="form-control" placeholder="N° Historia" minlength="9" maxlength="9">
        </div>
    </div>
    ...
    <div class="col">
        <label for="inputState" class="form-label"><Table>Regimen</Table></label>
        <select id="inputState" name="turno" class="form-select p-1 mt-0.5">
